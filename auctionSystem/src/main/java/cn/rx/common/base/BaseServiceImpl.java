...
import cn.rx.common.db.DataSourceEnum;
import cn.rx.common.db.DynamicDataSource;
import cn.rx.common.plugin.ResultColumns;
import cn.rx.common.utils.SpringContextUtil;
...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example> {
	...
	public Record selectFirstByExample(Example example) {
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
			String name = DataSourceEnum.SLAVE.getName();
