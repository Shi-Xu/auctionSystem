package cn.rx.common.listener;


import cn.rx.common.annotation.BaseService;
import cn.rx.common.base.BaseInterface;
...
public class ApplicationContextListener implements ApplicationListener<ApplicationStartedEvent> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(cn.rx.common.listener.ApplicationContextListener.class);
